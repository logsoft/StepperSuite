...
#
# Created: Sat Jun 30 01:33:32 2012
...
class Ui_Frame(object):
    def setupUi(self, Frame):
        ...
        Frame.resize(500, 360)
        Frame.setFrameShape(QtGui.QFrame.StyledPanel)
        Frame.setFrameShadow(QtGui.QFrame.Raised)
        self.tableWidget_points = QtGui.QTableWidget(Frame)
        self.tableWidget_points.setGeometry(QtCore.QRect(0, 0, 500, 215))
        ...
        self.tableWidget_points.horizontalHeader().setDefaultSectionSize(76)
        self.tableWidget_points.verticalHeader().setDefaultSectionSize(20)
        self.pushButton_teachNew = QtGui.QPushButton(Frame)
        self.pushButton_teachNew.setGeometry(QtCore.QRect(10, 220, 140, 26))
        font = QtGui.QFont()
        ...
        self.pushButton_teachInsert.setGeometry(QtCore.QRect(150, 220, 140, 26))
        font = QtGui.QFont()
        font.setFamily("DejaVu Sans Mono")
        font.setPointSize(10)
        ...
        self.pushButton_deleteRow.setGeometry(QtCore.QRect(290, 220, 140, 26))
        font = QtGui.QFont()
        font.setFamily("DejaVu Sans Mono")
        font.setPointSize(10)
        ...
        self.pushButton_moveTo.setGeometry(QtCore.QRect(10, 270, 151, 41))
        font = QtGui.QFont()
        font.setFamily("DejaVu Sans Mono")
        font.setPointSize(10)
        ...
        self.pushButton_testcycle.setGeometry(QtCore.QRect(160, 270, 151, 41))
